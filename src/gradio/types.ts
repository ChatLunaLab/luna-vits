...
// https://github.com/gradio-app/gradio/blob/4a8555921980a30d2621c5eb7d6700704f2561ab/client/js/src/types.ts#L1
// API Data Types
...
export type client_return = {
    ...
    viewApi: (_fetch: typeof fetch) => Promise<ApiInfo<JsApiData>>
}
...
export interface DuplicateOptions extends ClientOptions {
    private?: boolean
    hardware?: string // (typeof hardware_types)[number]
    timeout?: number
}
